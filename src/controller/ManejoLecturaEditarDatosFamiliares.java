...
public class ManejoLecturaEditarDatosFamiliares implements ActionListener {
	...
	public ManejoLecturaEditarDatosFamiliares(Frame ventana) {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(verificaDni()) {
			if(verificaResponsable()) {
				...
				VentanaEditarDatosFamiliares v = new VentanaEditarDatosFamiliares(resp_1, resp_2, resp_3);
				v.setVisible(true);
