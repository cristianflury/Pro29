...
public class ManejoLecturaEditarDatosChicos implements ActionListener {
	...
	public  ManejoLecturaEditarDatosChicos( Frame ventana) {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if ( id == null || id.equals("")) {
			...
			if (verificaChico(chicoBuscado) == true) {
				...
				VentanaEditarDatosChicos v = new VentanaEditarDatosChicos(chicoBuscado);
				v.setVisible(true);
