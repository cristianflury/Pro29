...
import controller.ManejaActualizarRegistroResponsable;
import controller.ManejoCambioVentana;
import controller.ManejoLecturaEditarDatosFamiliares;
import model.Responsable;


public class VentanaEditarDatosFamiliares extends JFrame {

	
	/**
	 * 
	 */
	private static final long serialVersionUID = 6948728546105289698L;
	 ...
	 * Create the frame.
	 */
	public VentanaEditarDatosFamiliares(Responsable resp_1, Responsable resp_2, Responsable resp_3) {
	
		setTitle("Editar Datos Familiares Pro29");
		...
		JLabel etqTitulo = new JLabel("EDITAR DATOS FAMILIARES");
		etqTitulo.setForeground(Color.WHITE);
		panelTitulo.add(etqTitulo);
		etqTitulo.setIcon(new ImageIcon(VentanaEditarDatosFamiliares.class.getResource("/images/editarRegistro.png")));
		...
		ingresoVinculo.setEditable(true);
		...
		ingresoFechaNacimiento.setEditable(true);
		...
		ingresoDomicilio.setEditable(true);
		...
		ingresoCelular.setEditable(true);
		...
		ingresoOcupacion.setEditable(true);
		...
		ingresoNivelEducativo.setEditable(true);
		...
		ingresoNombre_2.setEditable(true);
		...
		ingresoApellido_2.setEditable(true);
		...
		ingresoVinculo_2.setEditable(true);
		...
		ingresoFechaNacimiento_2.setEditable(true);
		...
		ingresoEdad_2.setEditable(true);
		...
		ingresoDomicilio_2.setEditable(true);
		...
		ingresoCelular_2.setEditable(true);
		...
		ingresoOcupacion_2.setEditable(true);
		...
		ingresoNivelEducativo_2.setEditable(true);
		...
		ingresoNombre_3.setEditable(true);
		...
		ingresoApellido_3.setEditable(true);
		...
		ingresoVinculo_3.setEditable(true);
		...
		ingresoFechaNacimiento_3.setEditable(true);
		...
		ingresoEdad_3.setEditable(true);
		...
		ingresoDomicilio_3.setEditable(true);
		...
		ingresoCelular_3.setEditable(true);
		...
		ingresoOcupacion_3.setEditable(true);
		...
		ingresoNivelEducativo_3.setEditable(true);
		...
		btnVolver.addActionListener(new ManejoCambioVentana(new MenuEditarRegistro(), this));

			
		panelBotones.add(btnVolver);

		JButton btnEditarOtro = new JButton("Editar Otro");
		btnEditarOtro.setForeground(new Color(255, 255, 255));
		btnEditarOtro.setBackground(new Color(0, 128, 128));
		btnEditarOtro.setFont(new Font("Arial Black", Font.BOLD, 17));
		btnEditarOtro.setCursor(new Cursor(Cursor.HAND_CURSOR));
		btnEditarOtro.addActionListener(new ManejoLecturaEditarDatosFamiliares(this));

		
		panelBotones.add(btnEditarOtro);

		JButton btnGuardar = new JButton("Guardar Edici\u00F3n");
		btnGuardar.setForeground(new Color(255, 255, 255));
		btnGuardar.setBackground(new Color(0, 128, 128));
		btnGuardar.setFont(new Font("Arial Black", Font.BOLD, 17));
		btnGuardar.setCursor(new Cursor(Cursor.HAND_CURSOR));
		btnGuardar.addActionListener(new ManejaActualizarRegistroResponsable(this));
