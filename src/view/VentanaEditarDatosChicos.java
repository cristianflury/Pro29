...
import controller.ManejaActualizarRegistroChico;
...
public class VentanaEditarDatosChicos extends JFrame {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -7609840681365888068L;
	 ...
	 * Create the frame.
	 */
	public VentanaEditarDatosChicos(Chico chico) {
		...
		setTitle("Editar Datos Ni\u00F1o/a Pro29");
		...
		JLabel etqTitulo = new JLabel("EDITAR DATOS NI\u00D1O/A");
		etqTitulo.setBackground(Color.BLACK);
		panelTitulo.add(etqTitulo);
		etqTitulo.setIcon(new ImageIcon(VentanaEditarDatosChicos.class.getResource("/images/editarRegistro.png")));
		...
		btnEditarOtro.addActionListener(new ManejoLecturaEditarDatosChicos(this));
		...
		btnGuardar.addActionListener(new ManejaActualizarRegistroChico(this));
