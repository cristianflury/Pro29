...
public class VentanaEditarEntrevista extends JFrame {
	...
	public VentanaEditarEntrevista(Entrevista entre) {
		
		setTitle("Editar Datos Entrevista Pro29");
		...
		JLabel etqTitulo = new JLabel("EDITAR DATOS ENTREVISTA");
		panelTitulo2.add(etqTitulo);
		etqTitulo.setIcon(new ImageIcon(VentanaEditarEntrevista.class.getResource("/images/editarRegistro.png")));
		...
		JButton btnEditarOtra = new JButton("Editar Otra");
		btnEditarOtra.setForeground(new Color(255, 255, 255));
		btnEditarOtra.setBackground(new Color(0, 128, 128));
		btnEditarOtra.setFont(new Font("Arial Black", Font.BOLD, 17));
		btnEditarOtra.setCursor(new Cursor(Cursor.HAND_CURSOR));
		btnEditarOtra.addActionListener(new ManejaLecturaEditarEntrevista(this));

		
		panelBotones.add(btnEditarOtra);
		...
		btnGuardar.addActionListener(new ManejaActualizarEntrevista(this));
